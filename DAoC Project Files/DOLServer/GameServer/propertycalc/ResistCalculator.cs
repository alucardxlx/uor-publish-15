...
namespace DOL.GS.PropertyCalc
{
	...
	public class ResistCalculator : PropertyCalculator
	{
        ...
        public override int CalcValueFromItems(GameLiving living, eProperty property)
        {
            ...
            int itemBonusCap = (living.Level / 2 + 1) + GetResistAfterFiftyBonus(living);
        ...
        // Resist bonus for levels 50+ 60% bonus on top of the normal 1 point per 2 levels.
        public static int GetResistAfterFiftyBonus(GameLiving living)
        {
            if (living == null) return 0;
            if (living.Level <= 50) return 0;

            else return (((living.Level - 50) *6) /10);
        }
