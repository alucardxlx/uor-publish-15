...
namespace DOL.GS.PlayerClass
{
	...
	/// 
	/// </summary>
	[CharacterClassAttribute((int)eCharacterClass.TransendedBase, "Transended", "Transended")]
	public class ClassTransendedBase : DOL.GS.CharacterClassBase
	{
		public ClassTransendedBase() : base() {
			m_specializationMultiplier = 10;
			m_wsbase = 320;
			m_baseHP = 720;
			m_manaStat = eStat._First;
		}
