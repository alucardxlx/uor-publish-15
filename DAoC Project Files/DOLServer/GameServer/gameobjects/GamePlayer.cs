...
namespace DOL.GS
{
	...
	public class GamePlayer : GameLiving
	{
        ...
        public virtual int BaseLinesChosen
        {
            get { return DBCharacter != null ? DBCharacter.BaseLinesChosen: 0; }
            set { if (DBCharacter != null) DBCharacter.BaseLinesChosen = value; }
		...
		public virtual void OnLevelUp(int previouslevel)
		{
			...
			switch (Level)
			{
                ...
                case 60:
                    {
                        RespecAmountAllSkill++;  //Full Skill respec
