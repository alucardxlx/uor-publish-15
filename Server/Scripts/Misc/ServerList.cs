...
namespace Server.Misc
{
    public class ServerList
    {
        ...
        public static readonly string ServerName = "UO Factions TC";
    ...
    public class APH
    {
        ...
        public static void GameLogin(NetState state, PacketReader pvSrc)
        {
            ...
            if (loginevents.Accepted)
            {
               ...
               // if ( Core.AOS )                                           //
               // {                                                         //Need to work this if you have an AOS server
               // 	state.Send( SupportedFeatures.Instantiate() );          //I Dont use it, just commented it out.
               // }                                                         // 
