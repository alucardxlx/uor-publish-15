...
namespace Server.Items
{
	public abstract class BasePoleArm : BaseMeleeWeapon, IUsesRemaining
	{
		...
		public override void OnHit( Mobile attacker, Mobile defender, double damageBonus )
		{
			...
			if ( !Core.AOS && (attacker.Player || attacker.Body.IsHuman) && Layer == Layer.TwoHanded && (attacker.Skills[SkillName.Anatomy].Value / 400.0 + attacker.RawInt / 100.0) >= Utility.RandomDouble() )
			{
